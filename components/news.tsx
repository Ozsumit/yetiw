        ...
        >
          <CarouselContent className="-ml-8">
            {newsItems.map((item, idx) => (
              /* FIX: Removed unnecessary <> fragment wrapper. Key must be on the direct child of map */
              <CarouselItem
                key={idx}
                ...
                <div className="group cursor-pointer flex flex-col h-full">
                  ...
                  <div className="flex flex-col flex-grow">
                    ...
                    <div className="flex justify-between items-start gap-4 group/title">
                      <h3 className="text-xl font-bold leading-tight text-zinc-900 group-hover:text-zinc-600 transition-colors">
                        {item.title}
                      </h3>
