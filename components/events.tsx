...
export default function EventsSnippet() {
  ...
  return (
    <>
      <section className="py-24 px-4 md:px-8 bg-[#F2F2F2] font-sans text-zinc-900 relative">
      ...
      {selectedEvent && (
        ...
        >
          ...
          >
            {/* Modal Header Image/Color Area (Optional visual flair) */}
            ...
            <div className="px-8 pb-12 -mt-12 relative">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Placeholder for extra content you might add later */}
